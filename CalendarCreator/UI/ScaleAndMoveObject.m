...
@implementation ScaleAndMoveObject

@synthesize contentView, minWidth, minHeight, preventsPositionOutsideSuperview, delegate,imageContent,currX,currY;
...
- (void)setFrame:(CGRect)newFrame {
    ...
    if(imageContent != nil){
        ...
        UIImageView *iv = [[UIImageView alloc] initWithImage:imageContent];
        iv.frame = CGRectMake(5, 5, contentView.frame.size.width - 10, contentView.frame.size.height - 10);
...
- (void)translateUsingTouchLocation:(CGPoint)touchPoint {
    ...
    if (self.preventsPositionOutsideSuperview) {
        ...
        currX = touchPoint.x;
        currY = touchPoint.y;
        NSLog(@"currX = %f , currY = %f",currX,currY);
